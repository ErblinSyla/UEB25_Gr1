        ...
        <section class="contact">
            ...
            <script>
                document.getElementById('contact-form').addEventListener('submit', function(event) {
                    ...
                    // Check name: should not contain numbers
                    ...
                    // Check email: validate the format with regex
                    ...
                    // Check age: should be between 1 and 120
                    ...
                    // Check message: ensure it is not empty
