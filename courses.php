...
document.addEventListener("DOMContentLoaded", function () {
 ...
 function validateNotEmpty(value, errorId) {
  ...
  function validatePassword(password) {
    ...
    const regex = /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/;  // At least 8 characters, including a number
  ...
  document.getElementById('applyForm').addEventListener('submit', function(event) {
    ...
    // If all fields are valid, submit the form (you can customize this part for your backend)
    if (isValid) {
  ...
  // Add event listeners for 'blur' (losing focus) to check individual field validations
  ...
  // Optional: Handle file upload preview and drag-drop functionality
